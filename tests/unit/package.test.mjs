...
test('plugin, package, lockfiles, and marketplace metadata agree on 1.7.2 Beta', async () => {
  ...
  assert.equal(npmLock.version, '1.7.2');
  assert.equal(npmLock.packages[''].version, '1.7.2');
