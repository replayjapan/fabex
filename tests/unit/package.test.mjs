...
test('plugin, package, lockfiles, and marketplace metadata agree on 1.7.0 Beta', async () => {
  ...
  assert.equal(plugin.version, '1.7.0');
  assert.equal(pkg.version, '1.7.0');
  assert.equal(npmLock.version, '1.7.0');
  assert.equal(npmLock.packages[''].version, '1.7.0');
