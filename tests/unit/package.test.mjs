...
test('plugin, package, lockfiles, and marketplace metadata agree on 1.7.1 Beta', async () => {
  ...
  assert.equal(npmLock.version, '1.7.1');
  assert.equal(npmLock.packages[''].version, '1.7.1');
